...
def Currency_Coventer():    #creating a function
    ...
    while True:     # While-condition
        ...
        Indian_rupee = float(input("Enter the amount in Currencies: "))  #user message to enter amount in from above currencies
        user_currency = input("Enter the Currency you want to convert: ")   #user message to choose any currencies
        print("This is amount in Indian rupees")    #converted amount in indian rupees
